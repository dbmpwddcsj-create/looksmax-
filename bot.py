...
async def profile_photo(
    ...
    await message.answer(
        ...
        "Это необязательно.\n"
        "Если не хочешь указывать — просто нажми "
        "«⏭ Пропустить».",
...
async def select_look_type(
    ...
    # Сохраняем ID анкеты до очистки state,
    # чтобы кнопка совета работала после оценки.
    await state.update_data(
